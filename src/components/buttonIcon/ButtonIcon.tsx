...
const StyledButton = styled.button<Omit<ButtonIconProps, 'icon'>>`
  position: relative;
  ...
  ${({ theme, variant }) => {
    ...
    return css<Omit<ButtonIconProps, 'icon'>>`
      border-style: ${style};
      border-width: ${width};
...
export const ButtonIcon = ({ variant, bordered, icon, ...rest }: ButtonIconProps): React.ReactElement => (
